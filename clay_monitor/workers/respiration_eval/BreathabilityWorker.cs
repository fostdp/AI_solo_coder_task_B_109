...
public class BreathabilityWorker : BackgroundService, IBreathabilityService
{
    ...
    public BreathabilityWorker(IMessageBus bus, IOptions<BreathabilityOptions> options)
    {
        _bus = bus;
    ...
    private double CalculateHysteresis(double[] T, double[] RH, double moistureContent,
