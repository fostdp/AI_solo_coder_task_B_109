...
public class ChemicalReactionWorker : BackgroundService, IChemicalReactionService
{
    ...
    public ChemicalReactionWorker(IMessageBus bus, IOptions<ChemicalReactionOptions> options)
    {
        _bus = bus;
